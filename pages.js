    ...
    <section class="hero" id="hero">
        ...
        <div class="hero-container-center">
            ...
            <p class="hero-description-center">
                우리는 프리미엄 딸기 생산·유통과 우수 품종 육묘 사업을 영위하고, <br>B2B 파트너와 농가에 최적의 가치를 제공하는 기업입니다.
            </p>
    ...
    <section class="home-partners-section">
        <div class="home-partners-container">
            <div class="home-partners-copy animate-on-scroll">
                ...
                <h2 class="section-title">까다로운 브랜드가 선택한 두호딸기</h2>
                <p class="section-subtitle">
                    프리미엄 베이커리와 호텔, 백화점까지. 가장 까다로운 무대에서 이미 검증을 마친 두호딸기의 철저한 품질 관리, 이제 당신의 비즈니스에도 그 확실한 차이를 증명하겠습니다.
                </p>
            ...
            <div class="home-partner-logos animate-on-scroll animate-delay-1" aria-label="주요 파트너">
                <a href="#/partners?section=bakery" class="home-partner-logo-card">
                    <img src="images/뚜쥬루 로고 2_final_preTransparent.png" alt="뚜쥬루 빵돌가마마을" loading="lazy" decoding="async">
                    <span>베이커리</span>
                </a>
                <a href="#/partners?section=hotel" class="home-partner-logo-card">
                    <img src="images/인터콘티넨탈호텔_clean.png" alt="서울 인터컨티넨탈 호텔" loading="lazy" decoding="async">
                    <span>호텔</span>
                </a>
                <a href="#/partners?section=department" class="home-partner-logo-card">
...
function aboutPage() {
    ...
    <section class="page-hero">
        <div class="container">
            ...
            <p class="section-subtitle animate-on-scroll animate-delay-2">
                두호딸기는 10년 이상의 재배 노하우로 대한민국 최고 품질의 딸기를 생산·유통하고, 우량 모종 육묘를 통해 농가의 안정적인 생산을 지원하는 전문기업입니다.
            </p>
        </div>
    </section>
            ...
            <div class="story-timeline-left">
                ...
                <div class="story-paragraphs">
                    ...
                    <p class="animate-on-scroll animate-delay-2">
                        <strong>두호딸기는 타협하지 않습니다.</strong> <br>온 정성을 기울여 길러낸 최상급 두호딸기는 호텔과 백화점, 고급 베이커리의 까다로운 기준을 통과해 꾸준한 선택을 받고 있습니다.
                    </p>
                ...
                <div class="about-history animate-on-scroll">
                    ...
                    <div class="history-timeline">
                        ...
                        <div class="history-item">
                            ...
                            <div class="history-dot"></div>
                            <div class="history-content">
                                <h4>B2B 납품 본격화 · 육묘 사업 개시</h4>
                                <p>현대백화점 및 인터콘티넨탈 호텔 공급 계약 · 전문 육묘장 건설 · 식물공장 육묘 시작 (전북대와 공동 재배)</p>
                            </div>
                        </div>
                        <div class="history-item">
    ...
    <section class="core-philosophy-section">
        <div class="container">
            <div class="core-philosophy-header">
                ...
                <h2 class="section-title animate-on-scroll animate-delay-1">완벽한 한 알에 담긴<br class="br-desktop"><br class="br-mobile"> 두호딸기의 네 가지 약속</h2>
                <p class="section-subtitle animate-on-scroll animate-delay-2">
    ...
    <!-- Credentials: Patents + Organic Certification -->
    <section class="credentials-section">
        <div class="container">
            <div class="section-label animate-on-scroll">CREDENTIALS</div>
            <h2 class="section-title animate-on-scroll animate-delay-1">검증된 기술과 안전성</h2>
            <p class="section-subtitle animate-on-scroll animate-delay-2">
                독자적인 연구로 취득한 특허 기술과<br class="br-mobile"> 국가가 인증한 무농약 농법, 두 가지 모두로 증명합니다.
            </p>
            <div class="credentials-grid">
                <!-- Patent Card -->
                <div class="credential-card animate-on-scroll animate-delay-2">
                    <div class="credential-image-frame">
                        <img src="images/patent.jpg" alt="무병 딸기묘 재배 및 저온 처리 방법 특허증" loading="lazy"
                             onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
                        <div class="patent-image-fallback">
                            <span class="patent-fallback-icon">${brandIcon('file')}</span>
                            <p>특허증 이미지</p>
                            <small>images/patent.jpg</small>
                        </div>
                    </div>
                    <div class="credential-body">
                        <span class="patent-badge">특허 등록 · 2025.12.04</span>
                        <h3 class="credential-title">무병 딸기묘 재배 및 저온 처리 방법</h3>
                        <p class="credential-desc">
                            식물공장 환경에서 무병 딸기묘를 안정적으로 생산하는 핵심 기술.<br class="br-desktop"> 20년간 독점적 권리를 보유합니다.
                        </p>
                        <ul class="credential-highlight-list">
                            <li class="credential-highlight">
                                <span class="credential-highlight-icon">${brandIcon('shield')}</span>
                                <span><strong>배타적 권리 · 20년</strong> 식물공장 딸기 육묘 독점</span>
                            </li>
                            <li class="credential-highlight">
                                <span class="credential-highlight-icon">${brandIcon('academy')}</span>
                                <span><strong>전북대학교 공동 연구</strong> 무병묘 생산 성공</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <!-- Organic Cert Card -->
                <div class="credential-card credential-card--organic animate-on-scroll animate-delay-3">
                    <div class="credential-image-frame">
                        <img src="images/무농약 인증서.jpg" alt="무농약 농산물 인증서" loading="lazy"
                             onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
                        <div class="patent-image-fallback">
                            <span class="patent-fallback-icon">${brandIcon('shield')}</span>
                            <p>무농약 인증서 이미지</p>
                            <small>images/무농약 인증서.jpg</small>
                        </div>
                    </div>
                    <div class="credential-body">
                        <span class="patent-badge organic-badge">국립농산물품질관리원 · 무농약 인증</span>
                        <h3 class="credential-title">화학 농약 없이, 정직하게 키웁니다</h3>
                        <p class="credential-desc">
                            화학 합성 농약을 일절 사용하지 않은 안심 농산물 국가 공식 인증.<br class="br-desktop"> 매년 엄격한 심사로 갱신됩니다.
                        </p>
                        <ul class="credential-highlight-list">
                            <li class="credential-highlight">
                                <span class="credential-highlight-icon">${brandIcon('leaf')}</span>
                                <span><strong>합성 농약 0% 원칙</strong> 친환경 자연 농법 재배</span>
                            </li>
                            <li class="credential-highlight">
                                <span class="credential-highlight-icon">${brandIcon('shield')}</span>
                                <span><strong>아이에게도 안심</strong> 임산부·영유아도 신뢰</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="cta-section">
        <div class="cta-content">
            ...
            <p class="section-subtitle animate-on-scroll animate-delay-1">
                프리미엄 딸기 납품 혹은 딸기묘에 대해<br class="br-mobile"> 더 알고 싶으시다면 언제든지 문의해 주세요.
            </p>
...
function productsPage() {
    ...
    <section class="page-hero">
        <div class="container">
            <div class="section-label animate-on-scroll">OUR PRODUCTS</div>
            <h1 class="section-title animate-on-scroll animate-delay-1">프리미엄 딸기와<br class="br-mobile"> 우량 딸기묘</h1>
            <p class="section-subtitle animate-on-scroll animate-delay-2">
                10년 이상의 재배 노하우로 길러낸 일곱 가지 프리미엄 품종과,<br class="br-desktop">
                11년 기술력과 특허로 검증된 100% 야외 삽목 우량묘를 만나보세요.
            </p>
        </div>
    </section>
    ...
    <section class="order-section">
        <div class="order-container">
            ...
            <div class="order-products">
                ...
                <div class="order-variety-grid-bottom">
                    <div class="order-variety-card animate-on-scroll">
                        <div class="order-variety-img-placeholder" role="img" aria-label="홍희 딸기 이미지 준비중">이미지 준비중</div>
                        <div class="order-variety-name">홍희</div>
                        <div class="order-variety-eng">Honghee</div>
                        <p class="order-variety-desc">
                            진한 붉은빛과 균일한 과형의 품종.<br>
                            안정적인 수확량과 뛰어난 저장성.
                        </p>
                        <div class="order-variety-specs">
                            <div class="order-variety-spec">
                            ...
                            <div class="order-variety-spec">
                                <div class="order-variety-spec-value">균일</div>
                                <div class="order-variety-spec-label">과형</div>
                            </div>
                            <div class="order-variety-spec">
                                <div class="order-variety-spec-value">우수</div>
                                <div class="order-variety-spec-label">저장성</div>
                            </div>
                        </div>
                    </div>
                    <div class="order-variety-card animate-on-scroll animate-delay-1">
                        <div class="order-variety-img-placeholder" role="img" aria-label="센데렐라 딸기 이미지 준비중">이미지 준비중</div>
                        <div class="order-variety-name">센데렐라</div>
                        <div class="order-variety-eng">Cenderella</div>
                        <p class="order-variety-desc">
                            화이트 딸기 특유의 우아한 외관.<br>
                            부드러운 단맛과 희소성이 매력.
                        </p>
                        <div class="order-variety-specs">
                            <div class="order-variety-spec">
                                <div class="order-variety-spec-value">11~13°</div>
                                <div class="order-variety-spec-label">당도</div>
                            </div>
                            <div class="order-variety-spec">
                                <div class="order-variety-spec-value">부드러움</div>
                                <div class="order-variety-spec-label">단맛</div>
                            </div>
                            <div class="order-variety-spec">
                                <div class="order-variety-spec-value">희소</div>
                                <div class="order-variety-spec-label">특성</div>
                            </div>
                        </div>
                    </div>
                    <div class="order-variety-card animate-on-scroll animate-delay-2">
                        <div class="order-variety-img-placeholder" role="img" aria-label="조이베리 딸기 이미지 준비중">이미지 준비중</div>
                        <div class="order-variety-name">조이베리</div>
                        <div class="order-variety-eng">Joyberry</div>
                        <p class="order-variety-desc">
                            상큼한 산미와 달콤함의 밸런스.<br>
                            디저트·음료에 최적화된 풍미.
                        </p>
                        <div class="order-variety-specs">
                            ...
                            <div class="order-variety-spec">
                                <div class="order-variety-spec-value">상큼</div>
                                <div class="order-variety-spec-label">산미</div>
                            </div>
                            <div class="order-variety-spec">
                                <div class="order-variety-spec-value">밸런스</div>
                                <div class="order-variety-spec-label">풍미</div>
                            </div>
                        </div>
                    </div>
                    <div class="order-variety-card animate-on-scroll animate-delay-3">
                        <div class="order-variety-img-placeholder" role="img" aria-label="핑크캔디 딸기 이미지 준비중">이미지 준비중</div>
                        <div class="order-variety-name">핑크캔디</div>
                        <div class="order-variety-eng">Pink Candy</div>
                        <p class="order-variety-desc">
                            사탕처럼 달콤한 맛과 핑크빛 과육.<br>
                            SNS 비주얼로 인기 급상승 품종.
                        </p>
                        <div class="order-variety-specs">
                            <div class="order-variety-spec">
                            ...
                            <div class="order-variety-spec">
                                <div class="order-variety-spec-value">핑크</div>
                                <div class="order-variety-spec-label">과육</div>
                            </div>
                            <div class="order-variety-spec">
                                <div class="order-variety-spec-value">캔디향</div>
                                <div class="order-variety-spec-label">향</div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- 딸기묘 소개 섹션 -->
    <section class="seedling-section">
        <div class="container">
            <div class="seedling-header">
                <div class="section-label animate-on-scroll">SEEDLING SUPPLY</div>
                <h2 class="section-title animate-on-scroll animate-delay-1">건강한 딸기의 시작,<br>두호의 우량 딸기묘</h2>
                <p class="section-subtitle animate-on-scroll animate-delay-2">
                   11년 노하우와 특허 기술이 증명하는 100% 야외 삽목 우량묘.<br>
                   재배주 런너 없이 오직 튼실함만 담아 농가의 성공적인 수확을 돕겠습니다.
                </p>
            </div>

            <div class="seedling-content">
                <!-- 모주동 -->
                <div class="seedling-block animate-on-scroll">
                    <div class="seedling-block-header">
                        <span class="seedling-block-number">01</span>
                        <div>
                            <h3 class="seedling-block-title">모주동</h3>
                            <p class="seedling-block-eng">Mother Plant House</p>
                        </div>
                    </div>
                    <p class="seedling-block-desc">
                        우수 품종의 원주(어미묘)를 철저히 관리하는 핵심 시설입니다. 건강한 원주에서 삽목용 삽수를 채취하여 유전적으로 동일한 고품질 자묘를 대량 생산할 수 있는 기반을 마련합니다.
                    </p>
                    <div class="seedling-gallery">
                        <div class="seedling-gallery-item">
                            <img src="images/모주동1.jpg" alt="모주동 내부 - 딸기 원주 관리 시설" loading="lazy">
                        </div>
                        <div class="seedling-gallery-item">
                            <img src="images/모주동2.jpg" alt="모주동 - 건강한 어미묘 재배 환경" loading="lazy">
                        </div>
                    </div>
                    <div class="seedling-features">
                        <div class="seedling-feature">
                            <span class="seedling-feature-dot"></span>
                            <span>무병 원주 선발 및 격리 관리</span>
                        </div>
                        <div class="seedling-feature">
                            <span class="seedling-feature-dot"></span>
                            <span>재배주 런너 미사용 · 전량 삽목 방식</span>
                        </div>
                        <div class="seedling-feature">
                            <span class="seedling-feature-dot"></span>
                            <span>야외 육묘로 환경 적응력 강화</span>
                        </div>
                    </div>
                </div>

                <!-- 자묘동 -->
                <div class="seedling-block animate-on-scroll animate-delay-1">
                    <div class="seedling-block-header">
                        <span class="seedling-block-number seedling-number-green">02</span>
                        <div>
                            <h3 class="seedling-block-title">자묘동</h3>
                            <p class="seedling-block-eng">Daughter Plant House</p>
                        </div>
                    </div>
                    <p class="seedling-block-desc">
                        모주동에서 채취한 삽수를 삽목하여 독립적인 딸기묘로 키워내는 시설입니다. 야외 환경에서 자연 적응력을 갖추며 자란 묘는 뿌리 활착률이 높고, 농가에 공급 후에도 안정적인 생육을 보장합니다.
                    </p>
                    <div class="seedling-gallery">
                        <div class="seedling-gallery-item">
                            <img src="images/자묘동1.jpg" alt="자묘동 내부 - 딸기묘 육성 시설" loading="lazy">
                        </div>
                        <div class="seedling-gallery-item">
                            <img src="images/자묘동2.jpg" alt="자묘동 - 튼실한 딸기묘 재배 현장" loading="lazy">
                        </div>
                    </div>
                    <div class="seedling-features">
                        <div class="seedling-feature">
                            <span class="seedling-feature-dot dot-green"></span>
                            <span>삽목 방식으로 균일한 묘 육성</span>
                        </div>
                        <div class="seedling-feature">
                            <span class="seedling-feature-dot dot-green"></span>
                            <span>높은 활착률의 튼실한 뿌리</span>
                        </div>
                        <div class="seedling-feature">
                            <span class="seedling-feature-dot dot-green"></span>
                            <span>농가 맞춤 출하 시기 조절</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="showcase-header" style="text-align: center; margin-bottom: var(--space-3xl);">
                ...
                <p class="section-subtitle animate-on-scroll animate-delay-2" style="margin: 0 auto;">
                    대한민국을 대표하는 최상급 브랜드들이 두호딸기의 변함없는 가치를 인정하며,<br class="br-desktop"><br class="br-mobile"> 오랜 시간 완벽한 파트너십을 이어오고 있습니다.
                </p>
            </div>
            
            <!-- 카테고리 1: 베이커리 & 카페 -->
            <div class="client-category-block" id="section-bakery">
                <div class="client-category-header animate-on-scroll">
                    <div class="client-category-label">BAKERY &amp; CAFE</div>
                    <h3 class="client-category-title">베이커리 &amp; 카페</h3>
                </div>
                <div class="clients-list">
                    <!-- 뚜쥬루 -->
                    <div class="client-card animate-on-scroll animate-delay-1">
                        <div class="client-logo-box">
                            <img src="images/뚜쥬루 로고 2_final_preTransparent.png" alt="뚜쥬루" loading="lazy" decoding="async" style="transform: scale(1);">
                        </div>
                        <div class="client-info">
                            ...
                            <p class="client-desc">
                                ...
                                자연의 맛을 지켜내는 뚜쥬루의 올곧은 장인정신은, 온전한 과실을 맺기까지 시간을 아끼지 않는 두호딸기의 진정성과 깊이 맞닿아 있습니다.
                    ...
                    <div class="client-card animate-on-scroll animate-delay-2">
                        <div class="client-logo-box">
                            <img src="images/하얀풍차 로고2.png" alt="하얀풍차" loading="lazy" decoding="async" style="transform: scale(1);">
                        </div>
                        <div class="client-info">
                            <div class="client-badge">Since 2024</div>
                            <h3 class="client-name">하얀풍차 수원점</h3>
                            <p class="client-desc">
                                <strong>30년의 시간이 빚어낸, 수원 시민의 빵집.</strong><br>
                                1993년 작은 동네 빵집으로 시작해 '대전에 성심당이 있다면 수원에는 하얀풍차가 있다'는 말을 들을 만큼 오랜 시간 한결같은 맛과 정성으로 시민들의 사랑을 받아온 수원의 대표 베이커리. 
                                한 세대를 이어온 깊은 신뢰의 자리에는, 시간과 손길을 아끼지 않은 정직한 재료만이 오를 수 있습니다. 
                                시그니처 딸기 케이크와 시즌 디저트에 담기는 두호딸기의 최상급 과실은, 30년을 이어온 하얀풍차의 진심에 오늘의 단맛을 더합니다.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <!-- 디저트 갤러리 -->
                <div class="bakery-dessert-gallery animate-on-scroll">
                    <div class="dessert-gallery-header">
                        <div class="dessert-gallery-title">두호딸기로 완성된 시그니처 디저트</div>
                        <p class="dessert-gallery-subtitle">파트너 베이커리에서 탄생한 프리미엄 딸기 디저트를 곧 만나보실 수 있습니다.</p>
                    </div>
                    <div class="dessert-gallery-grid">
                        <div class="dessert-gallery-item dessert-placeholder"></div>
                        <div class="dessert-gallery-item dessert-placeholder"></div>
                        <div class="dessert-gallery-item dessert-placeholder"></div>
                        <div class="dessert-gallery-item dessert-placeholder"></div>
                    </div>
            ...
            <!-- 카테고리 2: 호텔 & 레스토랑 -->
            <div class="client-category-block" id="section-hotel">
                <div class="client-category-header animate-on-scroll">
                    <div class="client-category-label">HOTEL &amp; RESTAURANT</div>
                    <h3 class="client-category-title">호텔 &amp; 레스토랑</h3>
                </div>
                <div class="clients-list">
                    <!-- 서울 인터컨티넨탈 호텔 -->
                    <div class="client-card animate-on-scroll animate-delay-1">
                        <div class="client-logo-box">
                            <img src="images/인터콘티넨탈호텔_clean.png" alt="서울 인터컨티넨탈 호텔" loading="lazy" decoding="async" style="transform: scale(1.1);">
                        </div>
                        <div class="client-info">
                            ...
                            <p class="client-desc">
                                ...
                                오랜 시간 최고 수준의 전문성과 진정성 있는 환대로 손님에게 감동을 전해온 인터컨티넨탈 호텔. 그 엄격한 최고급 정찬의 기준을 통과한 핵심 식재료는 두호딸기의 최상급 '죽향'입니다. 
                                타협 없는 방식으로 길러내어 특유의 깊고 진한 붉은 빛깔을 띠는 완벽한 딸기가 수석 요리사의 섬세한 손길과 만나, 
                                귀빈들의 미각을 깨우는 잊지 못할 예술적 경험으로 완성됩니다.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <!-- 카테고리 3: 백화점 & 마트 -->
            <div class="client-category-block" id="section-department">
                <div class="client-category-header animate-on-scroll">
                    <div class="client-category-label">DEPARTMENT STORE</div>
                    <h3 class="client-category-title">백화점 &amp; 마트</h3>
                </div>
                <div class="clients-list">
                    <!-- 현대백화점 -->
                    <div class="client-card animate-on-scroll animate-delay-1">
                        ...
                        <div class="client-info">
                            ...
                            <p class="client-desc">
                                ...
                                단순한 식품관을 넘어 차별화된 맛의 경험과 격조 높은 생활 방식을 제안하는 현대백화점. 
                                단맛과 크기, 희소성까지 완벽함을 추구하는 백화점의 깐깐한 기준에 두호딸기의 한정 생산 과실이 화답했습니다. 
                                압도적인 과육과 탁월한 단맛을 품은 딸기는 최고급 명절 선물로 탄생하여, 가장 귀한 마음을 전하려는 손님들에게 절대적인 신뢰를 받고 있습니다.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form id="contact-form" onsubmit="handleFormSubmit(event)">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="contact-category">
                            ...
                            <option value="farm">딸기 농가</option>
